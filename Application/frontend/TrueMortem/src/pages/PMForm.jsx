...
const FormComponent = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.ChestcavityFreeairoradhesions) {
      newErrors.ChestcavityFreeairoradhesions = "Chest cavity condition is required";
    }
    ...
    if (!formData.HeartSizeinconfiguration) {
      newErrors.HeartSizeinconfiguration = "Heart size configuration is required";
    }
    ...
    if (!formData.recentIschaemicChanges) {
      newErrors.recentIschaemicChanges = "Recent Ischaemic Changes row needs to be filled";
    }

    // Validate myocardial fibrosis
    if (!formData.Myocardialfibrosispresentin) {
      newErrors.Myocardialfibrosispresentin = "Heart myocardial fibrosis condition is required";
    }

    // Validate concentric hypertrophy
    if (!formData.Concentrichypertrophydetected) {
      newErrors.Concentrichypertrophydetected = "Heart concentric hypertrophy detection is required";
    }
    ...
    if (!formData.BloodVesselsCoronaryarteries) {
      newErrors.BloodVesselsCoronaryarteries = "Coronary arteries condition is required";
    }
    ...
    if (!formData.BloodVesselsCoronaryarterycondition) {
      newErrors.BloodVesselsCoronaryarterycondition = "Coronary artery condition is required";
    }

    // Validate blood vessels calcified
    if (!formData.BloodVesselsclacifiedandstenosedwithpatchyatheromatousplaques) {
      newErrors.BloodVesselsclacifiedandstenosedwithpatchyatheromatousplaques = "Blood vessels' calcification status is required";
    }
    ...
    if (!formData.Atheromatousplaquespresentintheaorta) {
      newErrors.Atheromatousplaquespresentintheaorta = "Atheromatous plaques in the aorta status is required";
    }
  ...
  return (
    <div>
      ...
      <div className="max-w-6xl mx-auto bg-white bg-opacity-80 p-8 rounded-2xl shadow-lg mt-10">
        <h2 className="text-2xl font-bold text-center mb-6">
          Post-Mortem Data Entry
        </h2><AnimatedBackground />
        <div className="relative z-10 p-8 bg-opacity-80 rounded-lg shadow-lg ">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          {errors.nourished && <p className="error">{errors.nourished}</p>}
          </div>
          </div>
          ...
          <div>
          <label className="block font-semibold">Chest cavity-Free air or adhesions</label>
          <select
          ...
          {errors.ChestcavityFreeairoradhesions && <p className="error">{errors.ChestcavityFreeairoradhesions}</p>}
          </div>

          {/* Row 3: Three Columns */}
          {/* Pericardial Fluid */}
          <div>
          <label className="block font-semibold">Pericardial Fluid in (ml)</label>
          <input
            type="number"
            ...
            className="w-full mt-2 border border-gray-300 p-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none transition duration-300 transform hover:scale-102"
          />
          {errors.pericardialFluid && <p className="error">{errors.pericardialFluid}</p>}
          </div>
          ...
          <input
            ...
            className="w-full mt-2 border border-gray-300 p-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none transition duration-300 transform hover:scale-102"
          />
          {errors.heartSize && <p className="error">{errors.heartSize}</p>}
          </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6">
          <div>
          <label className="block font-semibold">Heart-Size in configuration</label>
          <select
          ...
          {errors.HeartSizeinconfiguration && <p className="error">{errors.HeartSizeinconfiguration}</p>}
          </div>
          ...
          {errors.HeartInjuries && <p className="error">{errors.HeartInjuries}</p>}
          </div>
          </div>
          ...
          {errors.normalMyocardium && <p className="error">{errors.normalMyocardium}</p>}
          </div>

          <div>
          {/*Recent ischaemic changes*/}
          <label className="block font-semibold">Recent ischaemic changes</label>
          <select
          ...
          {errors.recentIschaemicChanges && <p className="error">{errors.recentIschaemicChanges}</p>}
          </div>
          </div>
          ...
          <label className="block font-semibold">Myocardial fibrosis present in Heart</label>
          <select
          ...
          {errors.Myocardialfibrosispresentin && <p className="error">{errors.Myocardialfibrosispresentin}</p>}
          </div>
          
          
          <div>
          {/*Heart-Concentric hypertrophy detected*/}
          <label className="block font-semibold">Concentric hypertrophy detected in Heart</label>
          <select
          ...
          {errors.Concentrichypertrophydetected && <p className="error">{errors.Concentrichypertrophydetected}</p>}
          </div>
          </div>
          ...
          <div>
          {/*Heart-Valves normal*/}
          <label className="block font-semibold">Heart-Valves normal</label>
          <select
          ...
          {errors.HeartValvesnormal && <p className="error">{errors.HeartValvesnormal}</p>}
          </div>

          <div>
          {/*Blood Vessels-Coronary arteries*/}
          <label className="block font-semibold">Coronary arteries condition</label>
          <select
          ...
          {errors.BloodVesselsCoronaryarteries && <p className="error">{errors.BloodVesselsCoronaryarteries}</p>}
          </div>
          </div>
          ...
          <label className="block font-semibold">Blood Vessels-Free of Stenosis</label>
          <select
            name="FreeofStenosis"
          ...
          {errors.FreeofStenosis && <p className="error">{errors.FreeofStenosis}</p>}
          </div>
          ...
          {errors.BloodVesselsCoronaryarterycondition && <p className="error">{errors.BloodVesselsCoronaryarterycondition}</p>}
          </div>
          </div>
          ...
          {errors.BloodVesselsclacifiedandstenosedwithpatchyatheromatousplaques && <p className="error">{errors.BloodVesselsclacifiedandstenosedwithpatchyatheromatousplaques}</p>}
          </div>
          ...
          <div>
          <label className="block font-semibold">
          Patchy Atheromatous plaques percentage in Left anterior descending artery
          </label>
          <input
            type="number"
            ...
            className="w-full mt-2 border border-gray-300 p-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none transition duration-300 transform hover:scale-102"
          />
          {errors.BloodVesselsLeftanteriordescendingartery && <p className="error">{errors.BloodVesselsLeftanteriordescendingartery}</p>}
          </div>

          {/* Blood Vessels-right coronary artery */}
          <div>
          <label className="block font-semibold">Patchy Atheromatous plaques percentage in Right coronary artery</label>
          <input
            type="number"
            ...
            className="w-full mt-2 border border-gray-300 p-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none transition duration-300 transform hover:scale-102"
          />
          {errors.BloodVesselsrightcoronaryartery && <p className="error">{errors.BloodVesselsrightcoronaryartery}</p>}
          </div>

          {/* Blood Vessels-Left circumflex artery */}
          <div>
          <label className="block font-semibold">Patchy Atheromatous plaques percentage in Left circumflex artery</label>
          <input
            type="number"
            ...
            className="w-full mt-2 border border-gray-300 p-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none transition duration-300 transform hover:scale-102"
          />
          {errors.BloodVesselsLeftcircumflexartery && <p className="error">{errors.BloodVesselsLeftcircumflexartery}</p>}
          </div>
          ...
          {errors.Aortacondition && <p className="error">{errors.Aortacondition}</p>}
          </div>
          ...
          {errors.AortaInjuries && <p className="error">{errors.AortaInjuries}</p>}
          </div>
          ...
          {errors.Atheromatousplaquespresentintheaorta && <p className="error">{errors.Atheromatousplaquespresentintheaorta}</p>}
          </div>
          </div>
        ...
        {prediction && featureContributions && (
          <div id="prediction-result" className="mt-10 p-6 bg-gradient-to-r from-blue-50 to-blue-50 rounded-2xl shadow-xl max-w-6xl mx-auto">
            <h3 className="text-4xl font-bold text-center text-gray-800">Prediction Results</h3>
            <p className={`text-center text-xl font-semibold mt-4 ${
              prediction === "Heart-related death" ? "text-red-600" : "text-green-600"
            }`}>
              {prediction}
            </p>
        ...
        <div className="mt-8">
          <h3 className="text-lg font-semibold text-gray-700">Feature Contributions</h3>
        ...
        <div className="mt-8">
          <h3 className="text-lg font-semibold text-gray-700">Feature Contribution Distribution</h3>
          <div className="relative w-full h-96">
            <Pie
              data={{
                labels: Object.keys(featureContributions),
